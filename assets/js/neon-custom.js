...
;(function($, window, undefined){
	...
	$(document).ready(function(){
        ...
        {
            $(".autocompletar_afiliado").autocomplete({
    			source: 'vista/afiliado/buscar_afiliado.php',
                select: function(event, ui){
                            $("#id_afiliado").val(ui.item.id_cliente);                            
                            $("#ci").val(ui.item.ci);
            ...
            $(".autocompletar_cuenta").autocomplete({
            ...
            $(".autocompletar_cuenta_conciliacion").autocomplete({
    			source: 'vista/cuenta/buscar_cuenta.php',
                select: function(event, ui){
                            $("#id_cuenta").val(ui.item.id_cuenta);
                            $("#codigo_cuenta").val(ui.item.codigo_cuenta);                        
                            ...
                            if(ui.item.tipo == 'Grupo' || ui.item.tipo == 'GRUPO'){
                                jAlert("Seleccione una cuenta de DETALLE", "Mensaje", function(res){
                                    $(".autocompletar_cuenta_conciliacion").focus();    
                                });
                            }else{
            ...
            $(".autocompletar_cuenta_ini").autocomplete({
    			source: 'vista/cuenta/buscar_cuenta.php',
                select: function(event, ui){
                            $("#id_cuenta_ini").val(ui.item.id_cuenta);
                            $("#codigo_cuenta_ini").val(ui.item.codigo_cuenta);                        
                            $("#nombre_cuenta_ini").val(ui.item.nombre_cuenta);
                            $("#tipo_ini").val(ui.item.tipo);
                            if(ui.item.tipo == 'Grupo' || ui.item.tipo == 'GRUPO'){
                                jAlert("Seleccione una cuenta de DETALLE", "Mensaje", function(res){
                                    $(".autocompletar_cuenta_ini").focus();    
                                });
                            }else{
            ...
            $(".autocompletar_cuenta_fin").autocomplete({
    			source: 'vista/cuenta/buscar_cuenta.php',
                select: function(event, ui){
                            $("#id_cuenta_fin").val(ui.item.id_cuenta);
                            $("#codigo_cuenta_fin").val(ui.item.codigo_cuenta);                        
                            $("#nombre_cuenta_fin").val(ui.item.nombre_cuenta);
                            $("#tipo_fin").val(ui.item.tipo);
                            if(ui.item.tipo == 'Grupo' || ui.item.tipo == 'GRUPO'){
                                jAlert("Seleccione una cuenta de DETALLE", "Mensaje", function(res){
                                    $(".autocompletar_cuenta_fin").focus();    
                                });
                            }else{
		...
		if($.fn.validate){
    		...
    		$(".validate").validate({    		        
                                ...
                                show_loading_bar({
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    if(data.indexOf('Error')>=0 || data.indexOf('Modificacion')>=0)
                                                    {
                                                        //error
                                                    }
                                                    else
                                ...
                                show_loading_bar({
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){
                                                ...
                                                //window.location.reload();
                                                jAlert(data,'Mensaje',function(){
                                                    if(data.indexOf('Error')>=0 || data.indexOf('modificaciones')>=0)
                                                    {
                                                        //error
                                                    }
                                                    else
                ...
                $(".validate_movimiento").validate({
    				onkeyup: false,
    				errorClass: 'error',
    				validClass: 'valid',                
                    submitHandler: function(form) {   
                        jConfirm('Esta seguro de registrar?','Mensaje',function(resp){
        					if (resp){
                                show_loading_bar({
										pct: 50,
                                        delay: 5,
                    					    ...
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        var ventana = window.open("vista/reportes/visor_reporte.php?f=vista/movimiento/comprobante_pdf.php","Comprobante");
                                                        //frm.src = "vista/venta/factura.php";                  
                                                        //frm.focus();
                                                        //frm.print();                                                        
                                                        window.location.reload();                                                        
                                                    }
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {                                                        
                                                        var ventana = window.open("vista/reportes/visor_reporte.php?f=vista/aporte/recibo_aporte_pdf.php","Recibo Aporte");                                                                                                                
                                                        window.location.reload();                                                        
                                                    }
                                                });
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {                                                        
                                                        var ventana = window.open("vista/reportes/visor_reporte.php?f=vista/cuota/recibo_cuota_pdf.php","Recibo Cuota");                                                                                                                
                                                        window.location.reload();                                                        
                                                    }
                                                });
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {                                                        
                                                        var ventana = window.open("vista/reportes/visor_reporte.php?f=vista/pago_saldo_cuota/recibo_saldo_cuota_pdf.php","Recibo Cuota");                                                                                                                
                                                        window.history.back();                                                       
                                                    }
                                                });
		...
		{
			var $this = $(el),
				label = attrDefault($this, 'label', 'Seleccionar');

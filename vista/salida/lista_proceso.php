<?php
    ...
    $registros = $bd->Consulta("select * from salida s inner join vehiculo v on v.id_vehiculo=s.id_vehiculo
                                    ...
                                    where s.fecha between '$fecha_i' and '$fecha_f' and s.estado=1");    
?>
...
<h2>Salida
    <a target="_blank" href="vista/reportes/visor_reporte.php?f=vista/salida/planilla_salida_pdf.php&fecha_i=<?php echo $fecha_i; ?>&fecha_f=<?php echo $fecha_f; ?>&estado=1" class="btn btn-green btn-icon" style="float: right; margin-right: 5px;">
        REPORTE NO REGISTRADAS<i class="entypo-print"></i> 
    </a> 
</h2>
<br />        

...
<h2>Lista de Salidas</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		...
		<form name="frm_salida" id="frm_salida" action="?mod=salida&lista_solicitudes" method="GET" role="form" class="form-horizontal form-groups-bordered">
			<input type="hidden" name="mod" value="salida"/>
            <input type="hidden" name="pag" value="lista_solicitudes"/>

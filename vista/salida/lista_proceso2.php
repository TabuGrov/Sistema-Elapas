<?php
    ...
    $registros = $bd->Consulta("select * from salida s inner join vehiculo v on v.id_vehiculo=s.id_vehiculo
                                    ...
                                    where s.fecha='$fecha_actual' and s.estado=2");    
?>
    ...
    while($registro = $bd->getFila($registros)) 
    {
        ...
        echo "<tr>";        
            ...
            echo "</tr>";
                ...
                echo "<td>
                <a href='control/salida/modificarhora.php?id=$registro[id_salida]' class='accion btn btn-green btn-icon btn-xs'>REGISTRAR HORA DE LLEGADA <i class='entypo-pencil'></i></a>
                </td>";
            }
